def main():
    ...
    print ("It was "+time+" o'clock when I heard a knock at the door.I opened the door and there was a box full of" +items+" with a note saying From Mr. "+name.title() +"Just as I closed the door I heard a scream "+scream.upper()+
